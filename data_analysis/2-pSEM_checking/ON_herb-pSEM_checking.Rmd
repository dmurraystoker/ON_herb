...
abundance.data <- raw.SEM.data %>%
	select(Population, Season, Distance, Danaus, Rhyssomatus, Aphis_spp, Tetraopes, Liriomyza)

## Subset early data
early.abundances <- abundance.data %>%
  filter(Season == "Early") %>%
  rename(
    Danaus.early = Danaus, Rhyssomatus.early = Rhyssomatus, Aphis.early = Aphis_spp,
...
late.abundances <- abundance.data %>%
  filter(Season == "Late") %>%
  rename(
    Danaus.late = Danaus, Rhyssomatus.late = Rhyssomatus, Aphis.late = Aphis_spp,
...
early.presence.absence <- presence.absence.data %>%
  ...
  rename(
    ...
    Aphis.early = Aphis_spp, Tetraopes.early = Tetraopes,
...
late.presence.absence <- presence.absence.data %>%
  ...
  rename(
    ...
    Aphis.late = Aphis_spp, Tetraopes.late = Tetraopes,
