...
```{r Toronto Abundance ANCOVA: Check Assumptions, include = FALSE, fig.cap = "Diagnostic plots of the Toronto abundance ANCOVA. The model had slight but acceptable over-dispersion (dispersion statistic = 1.250)"}
...
```{r Toronto Richness ANCOVA: Check Assumptions, include = FALSE, fig.cap = "Diagnostic plots of the Toronto richness ANCOVA. The model has acceptable dispersion (dispersion statistics = 0.437)."}
...
```{r 5 Cities Abundance ANOVA: Check Assumptions, include = FALSE, fig.cap = "Diagnostic plots of the 5 Cities abundance ANOVA. The model has good dispersion (dispersion statistic = 0.959)."}
