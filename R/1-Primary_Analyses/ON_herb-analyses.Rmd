...
dudleya.continuous <- cal_palette(name = "dudleya", n = 6, type = "continuous")
show_col(dudleya.continuous)

## Standard palette for the site map
dudleya.map <- dudleya.continuous[c(1, 4, 7, 10, 12, 2)]

## Standard palette for the 5 Cities
dudleya.5 <- dudleya.continuous[c(1, 4, 7, 10, 12)]

# Palette for connecting lines in the 5 cities
dudleya.10.lines <- c("#7B3478", "#7B3478", "#3A5085", "#3A5085", "#3A5470", "#3A5470",
											"#C27269", "#C27269", "#6D4847", "#6D4847")
